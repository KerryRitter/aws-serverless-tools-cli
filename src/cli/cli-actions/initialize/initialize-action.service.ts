...
export class InitializeActionService {
  ...
  private async scaffoldCfn(options: {
    ...
    const files: Array<[string, string]> = [
      ...
      [
        ...
        assets.createCloudFormationContents(options.appName),
      ],
      [
        join('cfn', 'openapi.yaml'),
        assets.createSwaggerContents(options.stackName),
      ],
      [
        join('cfn', 'deploy.js'),
  ...
  private async updateNestPackageJsonConfig(appName: string) {
